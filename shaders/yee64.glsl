...
void main()
{
    ...
    r3 = r2.xyxy * r3;
    r5 = r2.xyxy * r5;
    r6 = texture(INPUT_TEXTURE_0, r5.zw);
    r5 = texture(INPUT_TEXTURE_0, r5.xy);
    ...
    r0.xy = (r2 * r0).xy;
    r8 = texture(INPUT_TEXTURE_0, r0.xy);
    ...
    r7 = r2.xyxy * r7;
    r2 = r2.xyxy * r6;
    r6 = texture(INPUT_TEXTURE_0, r2.zw);
    r2 = texture(INPUT_TEXTURE_0, r2.xy);
    ...
    r6 = texture(INPUT_TEXTURE_0, r3.xy);
    r3 = texture(INPUT_TEXTURE_0, r3.zw);
    ...
    r5 = texture(INPUT_TEXTURE_0, r4.xy);
    r4 = texture(INPUT_TEXTURE_0, r4.zw);
    ...
    r3 = texture(INPUT_TEXTURE_0, r7.xy);
    r5 = texture(INPUT_TEXTURE_0, r7.zw);
