...
void main()
{
    filterWidth = (INPUT_SIZE_0.y / OUTPUT_SIZE.y) / 3.0;
...
#endif
    {
        vec2 texcoordInPixels = texcoord * INPUT_SIZE_0;
#if defined(SHARPER)
        vec2 tempCoord = floor(texcoordInPixels) + 0.5;
        vec2 coord = tempCoord / INPUT_SIZE_0;
        ...
        float yCoord = tempY / INPUT_SIZE_0.y;
        ...
        vec3 colour = texture(INPUT_TEXTURE_0, tc).rgb;
